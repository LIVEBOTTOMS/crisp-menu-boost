              ...
              <SubscriptionProvider>
                <MenuProvider>
                  ...
                  <Routes>
                    ...
                    {/* Auth Routes - Using Improved Auth Page */}
                    <Route path="/auth" element={<ImprovedAuthPage />} />
                    <Route path="/login" element={<ImprovedAuthPage />} />
                    <Route path="/signup" element={<ImprovedAuthPage />} />
