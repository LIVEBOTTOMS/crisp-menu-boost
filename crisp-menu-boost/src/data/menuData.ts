  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "VAT 69 (30 ml)", price: "₹241", description: "Classic Scotch with smooth character" },
        { name: "Teachers Highland (30 ml)", price: "₹290", description: "Highland single malt excellence" },
        { name: "Teachers 50 (30 ml)", price: "₹319", description: "Premium 50-year heritage blend" },
        { name: "100 Pipers (30 ml)", price: "₹299", description: "Smooth Scotch with fruity notes" },
        ...
        { name: "Johnnie Walker Black Label (30 ml)", price: "₹599", description: "12-year aged premium Scotch" },
        { name: "Chivas Regal (30 ml)", price: "₹649", description: "Luxury Scotch with honey & vanilla" },
        { name: "Jack Daniel's (30 ml)", price: "₹549", description: "Tennessee whiskey, charcoal mellowed" },
        { name: "Jim Beam Bourbon (30 ml)", price: "₹449", description: "Kentucky straight bourbon whiskey" },
        { name: "Monkey Shoulder (30 ml)", price: "₹499", description: "Triple malt Scotch whisky" },
        { name: "Glenfiddich 12Y (30 ml)", price: "₹899", description: "Single malt Speyside excellence" },
        { name: "Talisker 10Y (30 ml)", price: "₹849", description: "Isle of Skye single malt" },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: "🍹",
      items: [
        { name: "Jägermeister (30 ml)", price: "₹399", description: "German herbal liqueur" },
