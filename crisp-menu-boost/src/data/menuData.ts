  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Blenders Pride", sizes: ["₹105", "₹210", "₹315", "₹630"], description: "Smooth blend of Indian grain spirits and Scotch malt" },
        { name: "Blenders Pride Reserve", sizes: ["₹115", "₹225", "₹335", "₹670"], description: "Rare malt reserve collection" },
