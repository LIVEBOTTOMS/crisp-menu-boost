  ...
  categories: [
    {
      ...
      items: [
        ...
        { name: "Fried Papad", price: "₹100", description: "Traditional crispy lentil wafers, lightly spiced" },
        { name: "Masala Papad", price: "₹100", description: "Topped with fresh onions, tomatoes & tangy chaat masala" },
        { name: "Veg Pakoda", price: "₹140", description: "Assorted vegetables in chickpea batter, golden fried" },
        { name: "Veg Crispie", price: "₹120", description: "Crunchy vegetable fritters with house-made green chutney" },
        { name: "Paneer Pakoda", price: "₹160", description: "Cottage cheese cubes in spiced gram flour coating" },
        { name: "Veg Cutlet", price: "₹140", description: "Hand-pressed mixed vegetable patties, herb-crusted" },
        { name: "Cheese Pakoda", price: "₹180", description: "Melting cheese encased in crispy golden batter", isBestSeller: true },
        { name: "Cheese Balls", price: "₹160", description: "Creamy cheese spheres with a crunchy breadcrumb shell" },
        { name: "French Fries", price: "₹130", description: "Hand-cut potatoes, twice-fried for extra crispiness" },
  ...
  categories: [
    {
      ...
      icon: "🍲",
      items: [
        { name: "Chicken Kolhapuri Firepot", price: "₹380", description: "Intensely spiced with dried red chilies & coconut" },
        {
        ...
        { name: "Slow-Cooked Butter Chicken Handi", halfPrice: "₹530", fullPrice: "₹900", description: "Velvety tomato-cream gravy with charred chicken" },
        { name: "Royal Murgh Musallam Handi", halfPrice: "₹580", fullPrice: "₹950", description: "Whole chicken stuffed with aromatic rice & eggs", isChefSpecial: true },
      ],
    },
    {
      ...
      icon: "🍖",
      items: [
        { name: "Mutton Ukkad Handi", halfPrice: "₹700", fullPrice: "₹1,200", description: "Traditional bone-in curry simmered for 6 hours" },
        { name: "Solapuri Mutton Handi", halfPrice: "₹740", fullPrice: "₹1,250", description: "Authentic Solapur-style with kala masala" },
        { name: "Kolhapuri Mutton Handi", halfPrice: "₹740", fullPrice: "₹1,250", description: "Fiery red gravy with freshly ground masala" },
        { name: "Rustic Mutton Curry", price: "₹400", description: "Home-style preparation with caramelized onions" },
        { name: "Signature Mutton Masala", price: "₹420", description: "Chef's special blend of 18 hand-roasted spices" },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "Egg Thali", price: "₹280", description: "Masala egg preparation, rassa, dal, rice, salad & assorted breads" },
        { name: "Classic Chicken Thali", price: "₹340", description: "Chicken fry, rassa, soup, rice, salad & assorted breads" },
        { name: "Royal Mutton Thali", price: "₹500", description: "Mutton fry, Solapuri rassa, soup, wajdi, rice, salad & assorted breads" },
      ],
    },
    {
      ...
      icon: "🥗",
      items: [
        { name: "Paneer Patiyala Royal", price: "₹360", description: "Creamy cottage cheese in rich cashew-tomato gravy" },
        { name: "Paneer Handi Signature", price: "₹350", description: "Slow-cooked in earthen pot with whole spices" },
        { name: "Paneer Tikka Masala / Lajawab Masala", price: "₹360", description: "Charred paneer cubes in smoky tomato sauce" },
        { name: "Classic Paneer Butter Masala", price: "₹370", description: "Silky makhani gravy with farm-fresh paneer" },
        { name: "Paneer Kadai Karari", price: "₹360", description: "Bell peppers & cottage cheese with kadai spices" },
        { name: "Diwani Paneer Handi", price: "₹380", description: "Mixed vegetables & paneer in aromatic curry" },
        { name: "Homestyle Paneer Masala", price: "₹340", description: "Simple, comforting preparation with onion-tomato base" },
        { name: "Paneer Bhurji Scramble", price: "₹330", description: "Crumbled cottage cheese with peppers & fresh herbs" },
        { name: "Kaju Rich Masala", price: "₹400", description: "Premium cashews in velvety saffron cream" },
        { name: "Kaju Cream Curry", price: "₹400", description: "Whole cashews swimming in delicate white gravy" },
        { name: "Veg Patiyala", price: "₹330", description: "Garden vegetables in royal Punjabi-style sauce" },
        { name: "Veg Kolhapuri Pot", price: "₹330", description: "Seasonal vegetables in spicy Kolhapuri masala" },
        { name: "Paneer Chilli", price: "₹460", description: "Indo-Chinese style paneer with bell peppers & soy sauce" },
        { name: "Mushroom Chilli", price: "₹380", description: "Button mushrooms in spicy garlic chilli sauce" },
        { name: "Gobi Manchurian", price: "₹420", description: "Crispy cauliflower in tangy Manchurian sauce" },
        { name: "Veg Spring Roll", price: "₹420", description: "Crispy rolls filled with fresh vegetables" },
        { name: "Honey Chilli Potato", price: "₹390", description: "Crispy potato fingers in sweet & spicy glaze" },
      ],
    },
  ],
};
