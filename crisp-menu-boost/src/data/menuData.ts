...
export const beveragesMenu: MenuSection = {
  ...
  categories: [
    ...
    },
    {
      ...
      icon: "🥃",
      items: [
        { name: "Imperial Blue", sizes: ["₹96", "₹156", "₹228", "₹420"], description: "Smooth blend with hints of oak & spice" },
        { name: "Royal Challenge", sizes: ["₹96", "₹180", "₹252", "₹480"], description: "Premium grain whisky with mellow character" },
        { name: "Royal Green", sizes: ["₹96", "₹156", "₹228", "₹420"], description: "Distinctively smooth with herbal notes" },
        { name: "Royal Stag", sizes: ["₹96", "₹180", "₹252", "₹480"], description: "India's iconic smooth whisky" },
        { name: "Royal Stag Barrel", sizes: ["₹108", "₹192", "₹276", "₹540"], description: "Barrel-select premium variant" },
        { name: "Signature", sizes: ["₹144", "₹264", "₹384", "₹720"], description: "Rare grain whisky with smooth finish" },
        { name: "McDowell's No.1", sizes: ["₹84", "₹156", "₹228", "₹420"], description: "India's largest-selling whisky" },
        { name: "Antiquity Blue", sizes: ["₹168", "₹288", "₹408", "₹768"], description: "Ultra-premium aged blend" },
        { name: "Blenders Pride", sizes: ["₹144", "₹264", "₹384", "₹720"], description: "Smooth blend of Indian grain spirits and Scotch malt" },
        { name: "Blenders Pride Reserve", sizes: ["₹168", "₹288", "₹408", "₹768"], description: "Rare malt reserve collection" },
        { name: "DSP Black", sizes: ["₹72", "₹132", "₹192", "₹360"], description: "Premium dark whisky blend" },
        { name: "Rockford Reserve", sizes: ["₹168", "₹288", "₹408", "₹780"], description: "Reserve collection with oak notes" },
        { name: "Rockford Classic", sizes: ["₹144", "₹264", "₹384", "₹720"], description: "Classic smooth blend" },
        { name: "Oaken Glow", sizes: ["₹120", "₹216", "₹312", "₹600"], description: "Oak-aged premium whisky" },
      ],
    },
    {
      ...
      icon: "🥃",
      items: [
        { name: "Ballantine's Finest", sizes: ["₹216", "₹384", "₹552", "₹1,080"], description: "Scottish blend with honey & apple notes" },
        { name: "Black & White", sizes: ["₹192", "₹384", "₹768", "₹1,080"], description: "Smoky Highland character with gentle peat" },
        { name: "Black Dog", sizes: ["₹192", "₹384", "₹768", "₹1,080"], description: "Triple gold matured for exceptional smoothness" },
        { name: "VAT 69", sizes: ["₹192", "₹360", "₹516", "₹1,020"], description: "Classic Scotch with smooth character" },
        { name: "Teachers Highland", sizes: ["₹216", "₹384", "₹552", "₹1,080"], description: "Highland single malt excellence" },
        { name: "Teachers 50", sizes: ["₹240", "₹456", "₹660", "₹1,200"], description: "Premium 50-year heritage blend" },
        { name: "100 Pipers", sizes: ["₹216", "₹384", "₹552", "₹1,080"], description: "Smooth Scotch with fruity notes" },
        { name: "Jameson Irish Whiskey", sizes: ["₹240", "₹456", "₹720", "₹1,320"], description: "Triple-distilled in Dublin. Smooth sherry sweetness, toasted wood & gentle spice. Ireland's finest.", isBestSeller: true },
        { name: "Johnnie Walker Red Label", sizes: ["₹216", "₹384", "₹552", "₹1,080"], description: "Bold & vibrant with cinnamon spice" },
